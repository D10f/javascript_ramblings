...
rg.addEntityComponent(e2, 'transform', { position: new Vector2D(1, 2) });
rg.addEntityComponent(e2, 'sprite', { width: 23, height: 44 });
rg.addEntityComponent(e2, 'shape', { color: 'asdsa', vertices: 3 });
rg.addEntityComponent(e3, 'sprite', { width: 16, height: 16 });
...
console.log(renderSystem.entities.length);
